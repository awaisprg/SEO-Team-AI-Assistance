  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-slate-50/40">
        ...
        <div className="bg-white border-b border-slate-200/80 px-4 py-2.5 flex items-center justify-between gap-3 shrink-0">
          <div className="flex items-center space-x-2 shrink-0">
            ...
            <button
              ...
              className="inline-flex items-center space-x-1.5 px-2.5 py-1.5 rounded-lg bg-white hover:bg-violet-50 text-slate-600 hover:text-[#7C52F5] border border-slate-200 hover:border-violet-200 text-xs font-medium transition-all shadow-2xs cursor-pointer"
              title="Start a fresh query"
            >
              <Plus className="w-3.5 h-3.5 text-[#7C52F5]" />
          ...
          <div className="flex items-center space-x-1.5 overflow-x-auto pb-0.5 scrollbar-none text-xs flex-1 justify-end">
            <span className="text-slate-400 font-medium whitespace-nowrap flex items-center shrink-0 pr-1 text-[11px]">
            ...
            {PROMPT_SUGGESTIONS.map((prompt, idx) => (
              <button
                ...
                className="px-2.5 py-1 rounded-md bg-white text-slate-600 border border-slate-200 hover:border-[#7C52F5] hover:text-[#7C52F5] hover:bg-violet-50/50 whitespace-nowrap font-medium transition-all shadow-2xs cursor-pointer shrink-0 text-[11px]"
              >
                {prompt}
              </button>
            ))}
